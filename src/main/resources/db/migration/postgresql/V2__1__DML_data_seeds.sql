...
VALUES (uuid_generate_v4(), 'Delivering on the UN’s 2030 Agenda for Sustainable Development','2018-11-26 07:00:00', '2018-11-28 19:00:00',
...
VALUES
(1, 'Kenya Launches Digital Economy Blueprint', 'https://res.cloudinary.com/dpnxlc0jh/image/upload/v1558011865/2019_Kenya_s_Digital_Economy_Blueprint_launch_q60rfv.jpg',
   'Uhuru leads African leaders in embracing Digital Blueprint',
  ' <p><img src="https://pbs.twimg.com/media/D6nk05CXoAANl9D.jpg" /></p><p>President Uhuru Kenyatta today joined other African Heads of State for the official opening of the Transform Africa Summit 2019 in Kigali, Rwanda, during which Kenya’s Digital Economy Blueprint was launched. Sophia the human robot made a special appearance at the Summit.</p><p><img src="https://pbs.twimg.com/media/D6nYNufWwAA3CEF.jpg" /></p><p>&#8220;Through the Digital Economy Blueprint, the Govt. aims at enhancing contribution of ICTs to the economy through digital governance solutions, digitizing business processes, facilitating infrastructure delivery, innovation-driven, entrepreneurship and promotion of digital skills&#8221; Stated President Uhuru.</p><p>President Kenyatta called on African countries to prioritize the integration of Information and Communication Technologies in their development plans, as they hold immense potential for economic transformation of the continent.</p><p><img src="https://pbs.twimg.com/media/D6nYB9hW0AAq-w9.jpg" /></p><p>President Kenyatta stated that Kenya has invested heavily in its digital network. The President pointed out the central role that the youth play in the digital economy of Africa, underscoring Kenya’s key intervention targeted at empowering young people with practical ICT skills.</p><p><img src="https://pbs.twimg.com/media/D6nlcp9XoAAV9B7.jpg" /></p><p>The President said Kenya will be at the forefront in driving Africa&#8217;s digital economy adding that the country&#8217;s globally acknowledged and revolutionary innovations such as MPESA mobile money ecosystem, are a demonstration of the continent&#8217;s limitless ICTs potential.</p> <p>The President underscored the importance of technology as a fundamental element of Africa’s economic journey to prosperity, noting that he looked forward to the rollout of a Pan-African digital economy strategy.</p><p><img src="https://pbs.twimg.com/media/D6njKshWsAIW1pD.jpg" /></p><p>President Kenyatta noted that Africa stands on the brink of a major transformation, not only as a new frontier for investment but as a continent driven by a young, vibrant and aggressively innovative population, brimming with immense potential.</p><p>President Uhuru Kenyatta also cautioned against the growing misuse of technology, stating that social vices propagated, especially by young people, threaten to widen divisions based on African narratives of ethnicity, social class, religion and race.</p><p>&nbsp;</p>',
  '<a href="https://www.kenyahighcom.org.my/kdeb" target="_blank">The Star</a>', TRUE, 33, '2018-11-05 18:36:38'),
...
<p>The NIFC is an operating framework managed by the NIFCA which is meant to facilitate and support the development of an efficient and competitive financial sector in Kenya.</p>
  ...
  (3, 'Tea Trade Association of Malaysia (TTAM) Courtesy Call', 'https://res.cloudinary.com/dpnxlc0jh/image/upload/ar_1:1,c_fill,g_auto,e_art:hokusai/v1558011187/2019_tea_traders_malaysia_oogxmi.jpg',
   'H.E. Amb. Francis Muhoro with Tea Trade Association of Malaysia (TTAM) Courtesy Call',
  '<p> On Thursday, 16th May, 2019, the team from Tea Trade Association of Malaysia (TTAM) paid a courtesy call to the High Commissioner, H.E. Amb. Francis Muhoro led by their Chairman Ir. C.K Liew. From statistics, Malaysia consumes 17,000 tons of tea per year while local tea accounts for only 3-4,000 tons; per capita tea intake is 900 grams per person per year and rising. With the high quality of our Kenyan tea and continued promotion, the market potential is huge. </p>
  <p>Kenya is in the top ten countries exporting tea to Malaysia. They discussed about the upcoming Malaysia International Tea & Coffee Expo 2019 organized by TTAM with support of Selangor State Government from 10-13th October 2019 to be held at MITEC in KL where Kenyan tea and coffee traders will be in attendance. It will also be an opportunity to showcase Kenyan tea and coffee and expand our market share.</p>',
